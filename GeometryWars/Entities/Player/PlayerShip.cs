...
namespace GeometryWars.Entities.Player
{
    internal class PlayerShip : Entity
    {
        ...
        private void MakeExhaustFire()
        {
            ...
            GeoWarsGame.ParticleManager.CreateParticle(TextureLoader.LineParticle, pos, Color.White*alpha, 60f,
                new Vector2(0.5f, 1),
                new ParticleState(velMid, ParticleType.Enemy));
            GeoWarsGame.ParticleManager.CreateParticle(TextureLoader.Glow, pos, midColor*alpha, 60f,
                new Vector2(0.5f, 1),
                new ParticleState(velMid, ParticleType.Enemy));
            ...
            GeoWarsGame.ParticleManager.CreateParticle(TextureLoader.Glow, pos, sideColor*alpha, 60f,
                new Vector2(0.5f, 1),
                new ParticleState(vel1, ParticleType.Enemy));
            GeoWarsGame.ParticleManager.CreateParticle(TextureLoader.Glow, pos, sideColor*alpha, 60f,
                new Vector2(0.5f, 1),
